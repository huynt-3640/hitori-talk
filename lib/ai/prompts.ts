...
export function buildSystemPrompt(context: PromptContext): string {
  return [
    ...
    '- After your response, check if the learner made any Japanese mistakes in their MOST RECENT message ONLY',
    '- Do NOT repeat corrections from previous messages. Only correct NEW mistakes in the latest message.',
    '',
